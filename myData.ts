export const skills = ["React", "TailwindCSS", "Typescript", "Firebase"];

export const services = [
  {
    id: 1,
    title: "Web Development",
    text: "I build solid and simple webpages from scratch or from a deisgn",
  },
  {
    id: 2,
    title: "SEO",
    text: "I optimize websites using tested SEO strategies to increase the visibility on search engines and so web users can explore and interact with you.",
  },
];
...
export const projects = [
	...
	},
	{
		title: "Dreamup",
		description:
			"A landing page for the Dreamup Challenge where people learn HTML and CSS in 4 weeks",
	...
	},
	{
		...
		description:
			"A country data representation showing country capital, languages and population",
	...
	},
	{
		...
		description:
			"A web app where users can get create memes when provided with the text",
	...
	},
	{
		title: "Movie Box",
		description:
			"A movie discovery web app that shows the most featured movies.",
	...
	},
	{
		title: "PixelDrag",
		description:
			"An image gallery that allows users manage the gallery through an intuitiv drag and drop interface.",
